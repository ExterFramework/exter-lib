-- Notify
RegisterNetEvent('exter-lib:notify')
AddEventHandler('exter-lib:notify', function(text,time, tip)
...
-- UI
RegisterNetEvent('exter-lib:openinfo', function(title, text)
    SendNUIMessage({
        message = 'info',
        toptext = title,
        text = text
...
RegisterNetEvent('exter-lib:closeinfo', function()
...
RegisterCommand("test2",function()
    QBCore.Functions.Notify("Test", "info")
end)
...
RegisterCommand("notify", function()
    TriggerEvent('exter-lib:notify', 'EXTERCITY 2.0', 5000, 'info')
    TriggerEvent('exter-lib:notify', 'EXTERCITY 2.0', 5000, 'error')
    TriggerEvent('exter-lib:notify', 'EXTERCITY 2.0', 5000, 'success')
end)
...
RegisterCommand("info", function()
    TriggerEvent('exter-lib:openinfo', 'EXTERCITY 2.0', 'SOBING GANTENG')
end)
